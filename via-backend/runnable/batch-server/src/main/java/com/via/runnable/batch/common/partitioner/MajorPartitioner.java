...
public class MajorPartitioner implements Partitioner {
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        int totalCount = majorCrawler.getTotalCount();
        int totalPages = (int) Math.ceil((double) totalCount / PAGE_SIZE);
        log.info("Major Pages: totalCount={}, totalPages={}", totalCount, totalPages);
