...
public class OAuth2Context {
    ...
    @Builder
    public OAuth2Context(String state, OAuth2Provider provider, String codeVerifier, String redirectPath, String redirectUri) {
        this.state = state;
    ...
    public OAuth2Context(String state, OAuth2Provider provider, String codeVerifier, String redirectPath, String redirectUri, LocalDateTime expiresAt) {
        this.state = state;
        this.provider = provider;
        this.codeVerifier = codeVerifier;
        this.redirectPath = redirectPath;
